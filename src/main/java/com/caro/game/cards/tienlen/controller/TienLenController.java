...
public class TienLenController {
    ...
    public String tienLenBot(@RequestParam(defaultValue = "easy") String difficulty,
        ...
        model.addAttribute("pageNote", hard
            ? "Bot hard uu tien danh bo bai hop le co gia tri tot hon va giu the chu dong. MVP chua day du luat chat nang cao."
            : "Bot easy danh ngau nhien trong cac nuoc hop le (uu tien bo bai nho/de danh). MVP chua day du luat chat nang cao.");
