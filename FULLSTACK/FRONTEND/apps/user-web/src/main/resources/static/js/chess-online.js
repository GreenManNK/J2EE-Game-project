(function () {
    ...
    document.addEventListener("DOMContentLoaded", () => {
        els = {
            ...
            userAvatar: document.getElementById("chessOnlineUserAvatar"),
            userMeta: document.getElementById("chessOnlineUserMeta"),
    ...
    function bindRealtimeLifecycle() {
        const resume = () => {
            ...
            if (!state.connected) {
                setConnectionStatus("Dang khoi phuc ket noi");
                setGameStatus(state.roomId
    ...
    function buildCurrentModeUrl(spectateMode) {
        try {
            ...
            const basePath = normalizedRoomId
                ? "/chess/online/room/" + encodeURIComponent(normalizedRoomId) + (spectateMode ? "/spectate" : "")
                : "/chess/online";
