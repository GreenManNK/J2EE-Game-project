(function () {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const openDrawer = () => {
      ...
      body.classList.remove("social-drawer-open");
      body.removeAttribute("data-open-social-drawer");
      document.querySelectorAll("[data-social-drawer]").forEach((panel) => {
        panel.setAttribute("aria-hidden", "true");
      });
      document.getElementById("socialDrawerBackdrop")?.setAttribute("aria-hidden", "true");
