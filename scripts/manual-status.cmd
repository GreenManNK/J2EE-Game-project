...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "$urlMatch=Select-String -Path 'cloudflared.err.log' -Pattern 'https://[a-z0-9-]+\.trycloudflare\.com' -AllMatches -ErrorAction SilentlyContinue | Select-Object -Last 1;" ^
...
echo ==================
echo.
echo Neu QUICK_TUNNEL_URL co gia tri, gui link do cho nguoi choi.
